...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Plot 3: Bar chart for average number of vehicles sold by vehicle type during the given year
...
# to run through terminal = python3.8 DV0101EN-Final-Assign-Part-2-Questions.py
